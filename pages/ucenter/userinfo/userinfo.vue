...
<!-- 			<uni-list-item class="item">
			...
			<uni-list-item class="item" title="姓名" :rightText="userInfo.data">
			</uni-list-item>
			<uni-list-item class="item" title="工号" :rightText="userInfo.username">
			</uni-list-item>
			<uni-list-item class="item" title="密码" :rightText="userInfo.password">
			</uni-list-item>
		</uni-list>

<template>
	<view class="about">
		<view class="box">
			...
			<text class="tip appName">移动应用</text>
			<!-- <text class="tip">create by lpq</text> -->
			<text class="tip">Version V1.0.0</text>
...
<!-- 			<view class="agreement-box" v-for="(agreement,index) in about.agreements" :key="index">
			...
			<text class="hint">Copyright © 2022</text>
			<text class="hint">利电能源集团</text>
		</view>
	</view>
</template>
<script>
